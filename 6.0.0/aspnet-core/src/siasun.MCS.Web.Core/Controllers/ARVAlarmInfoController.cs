...
namespace siasun.MCS.Controllers
{
    ...
    public class ARVAlarmInfoController : MCSControllerBase
    {
        protected readonly ITB_AlarmInfoEntityAppService AlarmInfoService;

        public ARVAlarmInfoController(ITB_AlarmInfoEntityAppService alarmInfoService, PermissionChecker permissionChecker)
        {
        ...
        public async Task<ARVAlarmInfoModel.ARVAlarmFormReturn> PostAlarmInfoDataAsync([FromBody] ARVAlarmInfoModel.ARVAlarmQueryData obj1)
        {
            ...
            GetTB_AlarmInfoEntitysInput input = new GetTB_AlarmInfoEntitysInput();
