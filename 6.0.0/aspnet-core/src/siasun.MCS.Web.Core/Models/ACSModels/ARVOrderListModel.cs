...
{
    public class ARVOrderListModel
    {
        public class ARVOrderListQueryData
        {
        ...
        public class ARVOrderListTableData
        {
            public string arvid { get; set; }
        ...
        public class ARVOrderListFormReturn
        {
            public List<ARVOrderListTableData> data { get; set; }
