...
{
    public class ARVTaskLogModel
    {
        public class ARVTaskLogQueryData
        {
        ...
        public class ARVTaskLogTableData
        {
            public string arvid { get; set; }
        ...
        public class ARVTaskLogFormReturn
        {
            public List<ARVTaskLogTableData> data { get; set; }
