...
{
    public class ARVTaskListModel
    {
        public class ARVTaskListQueryData
        {
        ...
        public class ARVTaskListFormReturn
        {
            public List<ARVTaskListTableData> data { get; set; }
