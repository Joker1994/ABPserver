...
{
    public class ARVStatusTabelModel
    {
        public class ARVStatusQueryData
        {
        ...
        public class ARVStatusTableData
        {
            public string arvid { get; set; }
        ...
        public class ARVStatusFormReturn
        {
            public List<ARVStatusTableData> data { get; set; }
