...
```csharp
public DbSet<TP_TaskLogEntity>  TP_TaskLogEntitys { get; set; }
...
{
   modelBuilder.ApplyConfiguration(new TP_TaskLogEntityCfg());
 }
...
```
Add-Migration AddNewTP_TaskLogEntityEntity_Migration
```
