...
namespace siasun.MCS.Migrations
{
    ...
    [Migration("20210401013851_TP_OrderList")]
    partial class TP_OrderList
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("siasun.MCS.ACSEntitys.TP_OrderListEntity", b =>
                {
                    ...
                    b.Property<double>("C_SW02")
                        .HasColumnType("float");

                    b.Property<double>("C_SW03")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("c_LocationUpdateDateTime")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("c_OrderTypeNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("siasun.MCS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("siasun.MCS.Authorization.Users.User", null)
                        .WithMany("Claims")
