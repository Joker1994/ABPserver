...
{
    public abstract class MCSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MCSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MCSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MCSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MCSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MCSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MCSDbContext, Task<T>> func)
        {
            T result;
